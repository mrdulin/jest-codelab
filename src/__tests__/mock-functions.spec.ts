...
describe('mockFn test suites', () => {
  ...
  describe('mockFn.mock.calls', () => {
    ...
    it('An array that represents all calls that have been made into this mock function. Each call is represented by an array of arguments that' +
  ...
  describe('mockFn.mockImplementation(fn)', () => {
    ...
    it('Accepts a function that should be used as the implementation of the mock. ' +
  ...
  describe('mockFn.mockImplementationOnce(fn)', () => {
    ...
    it('Accepts a function that will be used as an implementation of the mock for one call to the mocked function. ' +
    ...
    it('When the mocked function runs out of implementations defined with mockImplementationOnce, ' +
